    ...
    public static void changeColors(Colors color){
        switch (color){
            case BLACK:
                ...
                HEADER_FONT = new Font(Font.BOLD_ITALIC, 20, com.badlogic.gdx.graphics.Color.WHITE);
            ...
            case WHITE:
                ...
                HEADER_FONT = new Font(Font.BOLD_ITALIC, 20, com.badlogic.gdx.graphics.Color.BLACK);
